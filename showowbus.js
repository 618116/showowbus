$(function ($) {
    ...
    $("#line").css("height",($(window).height() - $("#title_main").height() - 21) + "px");
    $("#home").css("height",($(window).height() - $("#title_home").height() - 46 - $("#select_bar").height()) + "px");
    $("#main").css("height",($(window).height() - $("#title_main").height() - 21) + "px");
    ...
    $("#main").on("click",".bustime",makeLine);
    ...
    function printLine(univOrStation,lineIndexNum){
        ...
        for ( var bus in line ) {
            if(line[bus]) $("#printLine").append(makeBusTimeHTML(univOrStation,lineNumber,false,bus));
